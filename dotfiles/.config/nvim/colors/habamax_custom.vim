" Slightly modified version of Habamax (included in the default nvim installation)

set background=dark

" hi clear
source $VIMRUNTIME/colors/vim.lua " Nvim: revert to Vim default color scheme
let g:colors_name = 'habamax_custom'
...
" let g:habamax_custom_dark_bg
if !exists('g:habamax_custom_dark_bg') || count([0,1], g:habamax_custom_dark_bg) == 0
    let g:habamax_custom_dark_bg = 1
endif
if g:habamax_custom_dark_bg == 1
  hi Normal guifg=#bcbcbc guibg=#1c1c1c gui=NONE cterm=NONE
else
  hi Normal guifg=#bcbcbc guibg=#303030 gui=NONE cterm=NONE
endif
...
hi CursorLineNr guifg=#bcbcbc guibg=#3a3a3a gui=bold cterm=bold
